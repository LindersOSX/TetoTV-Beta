...
The current Beta source build is `v2.0.64` with Android build code `410041`.
Its release title is:

```text
TetoTV 2.0.64 Beta - Android TV / Google TV / Fire TV
```
...
The current Beta uses build code `410041`. No Public counterpart is available.
...
code `410041` or higher. Uninstalling first permits an older APK but deletes
