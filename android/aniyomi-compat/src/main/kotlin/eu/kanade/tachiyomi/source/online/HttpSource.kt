...
abstract class HttpSource : CatalogueSource {
    ...
    /**
     * Lets the isolated compatibility boundary preserve an extension's exact,
     * overridden image request URL and playback-safe headers without executing it.
     * This is internal host plumbing, not an additional extension capability.
     */
    internal fun runtimeImageRequest(page: Page): Request = imageRequest(page)
