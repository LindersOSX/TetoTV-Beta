    ...
    try {
      ...
      try {
        return LibraryPlaybackRequest(
          ...
          serverAudioTracks: request.serverAudioTracks,
          selectedServerAudioTrackId: request.selectedServerAudioTrackId,
          onServerAudioTrackSelected: request.onServerAudioTrackSelected,
