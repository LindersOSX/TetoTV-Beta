...
The current Beta source build is `v2.0.67` with Android build code `410044`.
Its release title is:

```text
TetoTV 2.0.67 Beta - Android TV / Google TV / Fire TV
```
...
The current Beta uses build code `410044`. No Public counterpart is available.
...
code `410044` or higher. Uninstalling first permits an older APK but deletes
