...
The current Beta source build is `v2.0.62` with Android build code `410039`.
Its release title is:

```text
TetoTV 2.0.62 Beta - Android TV / Google TV / Fire TV
```
...
The current Beta uses build code `410039`. No Public counterpart is available.
...
code `410039` or higher. Uninstalling first permits an older APK but deletes
