...
abstract class AnimeHttpSource : AnimeCatalogueSource {
    ...
    /** API 17 browse-home ABI. Keeping this as a pure value exposes no Android context. */
    ...
    protected open fun popularAnimeRequest(page: Int): Request =
        throw UnsupportedOperationException("Popular anime request is unsupported")
    ...
    protected open fun popularAnimeParse(response: Response): AnimesPage =
        throw UnsupportedOperationException("Popular anime parsing is unsupported")
    ...
    protected open fun searchAnimeRequest(page: Int, query: String, filters: AnimeFilterList): Request =
        throw UnsupportedOperationException("Anime search request is unsupported")
    ...
    protected open fun searchAnimeParse(response: Response): AnimesPage =
        throw UnsupportedOperationException("Anime search parsing is unsupported")
    ...
    protected open fun latestUpdatesRequest(page: Int): Request =
        throw UnsupportedOperationException("Latest anime request is unsupported")
    ...
    protected open fun latestUpdatesParse(response: Response): AnimesPage =
        throw UnsupportedOperationException("Latest anime parsing is unsupported")
    ...
    protected open fun animeDetailsParse(response: Response): SAnime =
        throw UnsupportedOperationException("Anime details parsing is unsupported")
    ...
    protected open fun episodeListParse(response: Response): List<SEpisode> =
        throw UnsupportedOperationException("Episode list parsing is unsupported")

    /**
     * Legacy API 14 virtual slot. Some installed APKs override this member even
     * though the newer list API no longer calls it.
     */
    @Deprecated("Retained for extension API 14 binary compatibility")
    open fun episodeVideoParse(response: Response): SEpisode =
        throw UnsupportedOperationException("Episode video parsing is unsupported")
    ...
    protected open fun seasonListParse(response: Response): List<SAnime> =
        throw UnsupportedOperationException("Season list parsing is unsupported")
    ...
    protected open fun hosterListParse(response: Response): List<Hoster> =
        throw UnsupportedOperationException("Hoster list parsing is unsupported")
    ...
    protected open fun videoListParse(response: Response, hoster: Hoster): List<Video> =
        throw UnsupportedOperationException("Hoster video parsing is unsupported")
    ...
    protected open fun videoUrlParse(response: Response): String =
        throw UnsupportedOperationException("Video URL parsing is unsupported")
