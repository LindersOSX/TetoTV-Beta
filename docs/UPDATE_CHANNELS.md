...
The current Beta source build is `v2.0.76` with Android build code `410053`.
Its release title is:

```text
TetoTV 2.0.76 Beta - Android TV / Google TV / Fire TV
```
...
The current Beta uses build code `410053`. No Public counterpart is available.
...
code `410053` or higher. Uninstalling first permits an older APK but deletes
