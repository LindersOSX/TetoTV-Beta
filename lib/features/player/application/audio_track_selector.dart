...
/// Native MPV properties applied before a source opens.
///
/// `alang` makes MPV's first automatic choice match TetoTV's intent instead
/// of briefly (or permanently) accepting the container default. The later
