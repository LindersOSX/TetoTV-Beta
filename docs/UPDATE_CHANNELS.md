...
The current Beta source build is `v2.0.77` with Android build code `410054`.
Its release title is:

```text
TetoTV 2.0.77 Beta - Android TV / Google TV / Fire TV
```
...
The current Beta uses build code `410054`. No Public counterpart is available.
...
code `410054` or higher. Uninstalling first permits an older APK but deletes
